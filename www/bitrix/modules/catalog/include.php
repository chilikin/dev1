...
$arCatalogAvailProdFields = array(
	array("value"=>"IE_XML_ID", "field"=>"XML_ID", "important"=>"Y", "name"=>Loc::getMessage("CATI_FI_UNIXML_EXT")." (B_IBLOCK_ELEMENT.XML_ID)"),
	array("value"=>"IE_NAME", "field"=>"NAME", "important"=>"Y", "name"=>Loc::getMessage("CATI_FI_NAME")." (B_IBLOCK_ELEMENT.NAME)"),
	array("value"=>"IE_ACTIVE", "field"=>"ACTIVE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_ACTIV")." (B_IBLOCK_ELEMENT.ACTIVE)"),
	array("value"=>"IE_ACTIVE_FROM", "field"=>"ACTIVE_FROM", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_ACTIVFROM")." (B_IBLOCK_ELEMENT.ACTIVE_FROM)"),
	array("value"=>"IE_ACTIVE_TO", "field"=>"ACTIVE_TO", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_ACTIVTO")." (B_IBLOCK_ELEMENT.ACTIVE_TO)"),
	array("value"=>"IE_SORT", "field"=>"SORT", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_SORT_EXT")." (B_IBLOCK_ELEMENT.SORT)"),
	array("value"=>"IE_PREVIEW_PICTURE", "field"=>"PREVIEW_PICTURE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_CATIMG_EXT")." (B_IBLOCK_ELEMENT.PREVIEW_PICTURE)"),
	array("value"=>"IE_PREVIEW_TEXT", "field"=>"PREVIEW_TEXT", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_CATDESCR_EXT")." (B_IBLOCK_ELEMENT.PREVIEW_TEXT)"),
	array("value"=>"IE_PREVIEW_TEXT_TYPE", "field"=>"PREVIEW_TEXT_TYPE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_CATDESCRTYPE_EXT")." (B_IBLOCK_ELEMENT.PREVIEW_TEXT_TYPE)"),
	array("value"=>"IE_DETAIL_PICTURE", "field"=>"DETAIL_PICTURE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_DETIMG_EXT")." (B_IBLOCK_ELEMENT.DETAIL_PICTURE)"),
	array("value"=>"IE_DETAIL_TEXT", "field"=>"DETAIL_TEXT", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_DETDESCR_EXT")." (B_IBLOCK_ELEMENT.DETAIL_TEXT)"),
	array("value"=>"IE_DETAIL_TEXT_TYPE", "field"=>"DETAIL_TEXT_TYPE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_DETDESCRTYPE_EXT")." (B_IBLOCK_ELEMENT.DETAIL_TEXT_TYPE)"),
	array("value"=>"IE_CODE", "field"=>"CODE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_CODE_EXT")." (B_IBLOCK_ELEMENT.CODE)"),
	array("value"=>"IE_TAGS", "field"=>"TAGS", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_TAGS")." (B_IBLOCK_ELEMENT.TAGS)"),
	array("value"=>"IE_ID", "field"=>"ID", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_ID")." (B_IBLOCK_ELEMENT.ID)")
);
$defCatalogAvailProdFields = "IE_XML_ID,IE_NAME,IE_PREVIEW_TEXT,IE_DETAIL_TEXT";

$arCatalogAvailPriceFields = array(
	array("value"=>"CP_QUANTITY", "field"=>"QUANTITY", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_QUANT")." (B_CATALOG_PRODUCT.QUANTITY)"),
	array("value"=>"CP_QUANTITY_TRACE", "field"=>"QUANTITY_TRACE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_QUANTITY_TRACE")." (B_CATALOG_PRODUCT.QUANTITY_TRACE)"),
	array("value"=>"CP_CAN_BUY_ZERO", "field"=>"CAN_BUY_ZERO", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_CAN_BUY_ZERO")." (B_CATALOG_PRODUCT.CAN_BUY_ZERO)"),
	array("value"=>"CP_NEGATIVE_AMOUNT_TRACE", "field"=>"NEGATIVE_AMOUNT_TRACE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_NEGATIVE_AMOUNT_TRACE")." (B_CATALOG_PRODUCT.NEGATIVE_AMOUNT_TRACE)"),
	array("value"=>"CP_WEIGHT", "field"=>"WEIGHT", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_WEIGHT")." (B_CATALOG_PRODUCT.WEIGHT)"),
	array("value"=>"CP_WIDTH", "field"=>"WIDTH", "important"=>"N", "name"=>Loc::getMessage('CATI_FI_WIDTH')." (B_CATALOG_PRODUCT.WIDTH)"),
	array("value"=>"CP_HEIGHT", "field"=>"HEIGHT", "important"=>"N", "name"=>Loc::getMessage('CATI_FI_HEIGHT')." (B_CATALOG_PRODUCT.HEIGHT)"),
	array("value"=>"CP_LENGTH", "field"=>"LENGTH", "important"=>"N", "name"=>Loc::getMessage('CATI_FI_LENGTH')." (B_CATALOG_PRODUCT.LENGTH)"),
	array("value"=>"CP_PURCHASING_PRICE", "field"=>"PURCHASING_PRICE", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_PURCHASING_PRICE")." (B_CATALOG_PRODUCT.PURCHASING_PRICE)"),
	array("value"=>"CP_PURCHASING_CURRENCY", "field"=>"PURCHASING_CURRENCY", "important"=>"N", "name"=>Loc::getMessage("CATI_FI_PURCHASING_CURRENCY")." (B_CATALOG_PRODUCT.PURCHASING_CURRENCY)"),
	array("value"=>"CP_PRICE_TYPE", "field"=>"PRICE_TYPE", "important"=>"N", "name"=>Loc::getMessage("I_PAY_TYPE")." (B_CATALOG_PRODUCT.PRICE_TYPE)"),
	array("value"=>"CP_RECUR_SCHEME_LENGTH", "field"=>"RECUR_SCHEME_LENGTH", "important"=>"N", "name"=>Loc::getMessage("I_PAY_PERIOD_LENGTH")." (B_CATALOG_PRODUCT.RECUR_SCHEME_LENGTH)"),
	array("value"=>"CP_RECUR_SCHEME_TYPE", "field"=>"RECUR_SCHEME_TYPE", "important"=>"N", "name"=>Loc::getMessage("I_PAY_PERIOD_TYPE")." (B_CATALOG_PRODUCT.RECUR_SCHEME_TYPE)"),
	array("value"=>"CP_TRIAL_PRICE_ID", "field"=>"TRIAL_PRICE_ID", "important"=>"N", "name"=>Loc::getMessage("I_TRIAL_FOR")." (B_CATALOG_PRODUCT.TRIAL_PRICE_ID)"),
	array("value"=>"CP_WITHOUT_ORDER", "field"=>"WITHOUT_ORDER", "important"=>"N", "name"=>Loc::getMessage("I_WITHOUT_ORDER")." (B_CATALOG_PRODUCT.WITHOUT_ORDER)"),
	array("value"=>"CP_VAT_ID", "field"=>"VAT_ID", "important"=>"N", "name"=>Loc::getMessage("I_VAT_ID")." (B_CATALOG_PRODUCT.VAT_ID)"),
	array("value"=>"CP_VAT_INCLUDED", "field"=>"VAT_INCLUDED", "important"=>"N", "name"=>Loc::getMessage("I_VAT_INCLUDED")." (B_CATALOG_PRODUCT.VAT_INCLUDED)"),
);
$defCatalogAvailPriceFields = "CP_QUANTITY,CP_WEIGHT,CP_WIDTH,CP_HEIGHT,CP_LENGTH";

$arCatalogAvailValueFields = array(
	array("value"=>"CV_PRICE", "value_size" => 8, "field"=>"PRICE", "important"=>"N", "name"=>Loc::getMessage("I_NAME_PRICE")." (B_CATALOG_PRICE.PRICE)"),
	array("value"=>"CV_CURRENCY", "value_size" => 11, "field"=>"CURRENCY", "important"=>"N", "name"=>Loc::getMessage("I_NAME_CURRENCY")." (B_CATALOG_PRICE.CURRENCY)"),
	array("value"=>"CV_EXTRA_ID", "value_size" => 11, "field"=>"EXTRA_ID", "important"=>"N", "name"=>Loc::getMessage("I_NAME_EXTRA_ID")." (B_CATALOG_PRICE.EXTRA_ID)"),
);
$defCatalogAvailValueFields = "CV_PRICE,CV_CURRENCY"; // CV_QUANTITY_FROM,CV_QUANTITY_TO,

$arCatalogAvailQuantityFields = array(
	array("value"=>"CV_QUANTITY_FROM", "field"=>"QUANTITY_FROM", "important"=>"N", "name"=>Loc::getMessage("I_NAME_QUANTITY_FROM")." (B_CATALOG_PRICE.QUANTITY_FROM)"),
	array("value"=>"CV_QUANTITY_TO", "field"=>"QUANTITY_TO", "important"=>"N", "name"=>Loc::getMessage("I_NAME_QUANTITY_TO")." (B_CATALOG_PRICE.QUANTITY_TO)"),
);
$defCatalogAvailQuantityFields = "CV_QUANTITY_FROM,CV_QUANTITY_TO";

$arCatalogAvailGroupFields = array(
	array("value"=>"IC_XML_ID", "field"=>"XML_ID", "important"=>"Y", "name"=>Loc::getMessage("CATI_FG_UNIXML_EXT")." (B_IBLOCK_SECTION.XML_ID)"),
	array("value"=>"IC_GROUP", "field"=>"NAME", "important"=>"Y", "name"=>Loc::getMessage("CATI_FG_NAME")." (B_IBLOCK_SECTION.NAME)"),
	array("value"=>"IC_ACTIVE", "field"=>"ACTIVE", "important"=>"N", "name"=>Loc::getMessage("CATI_FG_ACTIV")." (B_IBLOCK_SECTION.ACTIVE)"),
	array("value"=>"IC_SORT", "field"=>"SORT", "important"=>"N", "name"=>Loc::getMessage("CATI_FG_SORT_EXT")." (B_IBLOCK_SECTION.SORT)"),
	array("value"=>"IC_DESCRIPTION", "field"=>"DESCRIPTION", "important"=>"N", "name"=>Loc::getMessage("CATI_FG_DESCR")." (B_IBLOCK_SECTION.DESCRIPTION)"),
	array("value"=>"IC_DESCRIPTION_TYPE", "field"=>"DESCRIPTION_TYPE", "important"=>"N", "name"=>Loc::getMessage("CATI_FG_DESCRTYPE")." (B_IBLOCK_SECTION.DESCRIPTION_TYPE)"),
	array("value"=>"IC_CODE", "field"=>"CODE", "important"=>"N", "name"=>Loc::getMessage("CATI_FG_CODE_EXT2")." (B_IBLOCK_SECTION.CODE)"),
	array("value"=>"IC_PICTURE", "field" => "PICTURE", "important" => "N", "name" => Loc::getMessage("CATI_FG_PICTURE")." (B_IBLOCK_SECTION.PICTURE)"),
	array("value"=>"IC_DETAIL_PICTURE", "field" => "DETAIL_PICTURE", "important" => "N", "name" => Loc::getMessage("CATI_FG_DETAIL_PICTURE")." (B_IBLOCK_SECTION.DETAIL_PICTURE)"),
);
...
function Add2Basket($PRICE_ID, $QUANTITY = 1, $arRewriteFields = array(), $arProductParams = array())
{
	...
	if (Loader::includeModule("statistic") && isset($_SESSION['SESS_SEARCHER_ID']) && 0 < intval($_SESSION["SESS_SEARCHER_ID"]))
	{
