...
if ($USER->CanDoOperation('catalog_read')) :
	...
	if(CModule::IncludeModule("iblock")):
		...
		$arBaseOptions = array(
			...
			array("1C_TRANSLIT_ON_ADD", GetMessage("CAT_1C_TRANSLIT_ON_ADD_2"), "Y", Array("checkbox")),
			array("1C_TRANSLIT_ON_UPDATE", GetMessage("CAT_1C_TRANSLIT_ON_UPDATE_2"), "Y", Array("checkbox")),
			array("1C_TRANSLIT_REPLACE_CHAR", GetMessage("CAT_1C_TRANSLIT_REPLACE_CHAR"), "_", Array("text", 1)),
		);
