...
$MESS ['BPT_ST_APPROVE_NAME'] = "Утверждение документа \"{=Document:NAME}\"";
$MESS ['BPT_ST_APPROVE_DESC'] = "Вы должны утвердить документ \"{=Document:NAME}\":
...
$MESS ['BPT_ST_APPROVE_TITLE'] = "Утверждение документа";
...
$MESS ['BPT_ST_PUBDC'] = "Публикация документа";
?>