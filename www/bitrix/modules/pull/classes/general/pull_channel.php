...
class CPullChannel
{
	...
	public static function DeleteByUser($userId, $channelId = null, $channelType = 'private')
	{
		global $DB, $CACHE_MANAGER;
		...
		$strSql = "DELETE FROM b_pull_channel WHERE USER_ID = ".$userId." AND CHANNEL_TYPE = '".$DB->ForSQL($channelType)."'";
		$DB->Query($strSql, false, "File: ".__FILE__."<br>Line: ".__LINE__);
